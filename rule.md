...
8. 위키 관련 대화를 하는 행위. 단, 아래와 같은 경우에는 예외로 합니다.
    ...
    - 위키미디어 재단에서 운영하는 위키의 문서의 링크를 첨부하는 경우
        - 사용자 문서는 허용하지 않습니다.
9. 부적절한 언행으로 다른 이에게 피해를 끼치거나 채팅 분위기를 흐리는 행위
10. 교통 관련 대화를 “교통” 채널 및 포럼 채널 이외의 채널에서 하는 행위
    - 여기에서 포럼 채널이란 채널 유형이 포럼인 채널을 의미합니다.
11. 개발, 코딩 관련 대화를 “개발” 채널 및 포럼 채널 이외의 채널에서 하는 행위
    - 여기에서 포럼 채널이란 채널 유형이 포럼인 채널을 의미합니다.
12. 반양지 서버에 맞지 않는 행위
13. 서버 음지화 또는 음지 채널 개설을 요구하는 행위
14. 메시지를 보낼 때마다 스레드가 만들어지는 채널(투표, 노래 추천, 유튜브 영상 추천 등)에서 스레드 밖에서 잡담을 하는 행위
15. 반응 추가/제거를 지속적으로 짧은 시간 내에 반복하는 행위
