...
10. 특정 주장을 진지하게 주장하다가 본인 주장에 대한 반박이 있을 때 이에 대해 재반박하거나 본인의 논리적 오류를 인정하지 않고 논점일탈의 오류를 범하는 행위. 이는 다음을 포함하지만 이에 국한되지는 않습니다.
...
11. 본인의 인맥 또는 지위를 악용하는 모든 행위
    - 여기서 “지위"란, 운영진 직책을 의미하지 아니하며 서버에 미치는 영향력 등을 의미합니다.
12. 운영 관련 주제에 대해 본인이 아닌 다른 유저들이 특정 주장을 지지하도록 의도적으로 조장하는 모든 행위
13. 운영진의 지시를 정당한 사유 없이 따르지 아니하는 행위
14. 운영진의 지시에 대해 진지하지 아니한 태도로 반응하는 행위
15. 서버에 대한 문의 중 특정 인물에 대해 직간접적으로 비판하는 내용이 포함되어 있는 문의를 공개 접수하는 행위
...
4. 같은 사람이 사용하는 계정이 여러 개일 때, 그 중 두 개 이상의 계정을 서버에 참가시키는 행위
